    ...
    >
      <thead>
        <tr class="bg-slate-100 text-center text-xs font-[KhmerOSMoul]">
          <th class="border border-slate-500 text-xs text-center w-[40px] py-4">
            ល.រ
          </th>
          <th
            class="border border-slate-500 text-xs text-center w-[400px] py-4"
          >
            ឈ្មោះផ្លូវការ
          </th>
          <th
            class="border border-slate-500 text-xs text-center w-[200px] py-4 md:w-[120px]"
          >
            លេខ និងកាលបរិច្ឆេទ
          </th>
          <th
            class="border border-slate-500 text-xs text-center w-[100px] py-4"
          >
            ឈ្មោះហៅកាត់
          </th>
          <th class="border border-slate-500 text-xs text-center w-[80px] py-4">
            ផ្សេងៗ
          </th>
        </tr>
      </thead>
      <tbody>
        <template v-if="pending">
          <RegisterLawSkeleton v-for="item in items" :key="item?.id" />
        </template>
